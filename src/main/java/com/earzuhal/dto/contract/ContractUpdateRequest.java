...
/**
 * Mevcut sözleşmeler için kısmi güncelleme isteği.
 * Yalnızca gönderilen alanlar değişir; başlık zorunluluğu yoktur (DRAFT sözleşmenin
 * tutarı tek başına güncellenebilmelidir).
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
